  ...
  _renderMiddle() {
    return (
      <View style={[styles.navBarItem, { flex: 0.6, alignItems: "center", justifyContent: "center" }]}>
        <Animatable.Text animation="slideInLeft" delay={200}
          useNativeDriver style={{ fontSize: 15, color: MODAL_BG_COLOR, fontFamily: FONT_FAMILY_BOLD }}>{this.props.title}</Animatable.Text>
      </View>
    )
  }
